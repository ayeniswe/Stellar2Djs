 ...
 * @param {LevelEditor} editor - The instance of the LevelEditor class representing the level editor.
 *
 * @module useEditor
 *
 * @description
 * The `editor` parameter is an instance of the LevelEditor class, which plays a crucial role in the functionality of these hooks.
...
const useEditor = (editor: LevelEditor) => {
     ...
     * Finally, it calls the `LevelEditorDesign.setBrush` function to update the brush in the level editor. The `LevelEditorDesign.setBrush` static instance plays a crucial role in integration for rendering texture on canvas based on UI interaction.
     */
    ...
    const getGroups = (): JSX.Element[] => {
        ...
        return Object.keys(groups).map(name => {
            return (
                <div className='LevelEditor__content__group' key={name}>
     ...
     * The JSX element is created with a container element having the CSS class `LevelEditor__content`.
