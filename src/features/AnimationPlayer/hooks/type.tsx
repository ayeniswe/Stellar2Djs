 ...
 *  updating the timeline slider and
 * displaying the current time in the timeline.
 */
type Timeline = {
    /**
     ...
     *
     * @description
     * This function resets the slider position
     ...
     */
    showFrames: () => React.JSX.Element[] | undefined;
    /**
     ...
     * @description
     * This function takes a position as
     * input and moves the physical slider to that position.
     ...
     *
     * @description
     * This function finds the necessary DOM
     * elements for the timeline slider (slider, sliderThumb, and timeline)
     * and assigns them to the `TIMELINE` object.
     * It also sets up an event listener for the window's `resize` event
     * to update the width of the
     * timeline and slider. Additionally, it
     * sets up an event listener for the `mousedown`
     * event on the sliderThumb element to
     * enable dragging the slider within the timeline dimensions. Finally, it
     * sets up an event listener for the `mouseup`
     *  event on the document to stop dragging when
...
/**
 * This hook provides functionality for controlling
...
type Controls = {
     ...
     * At any time it can be stopped. Also it can be
     * repeated if looping is enabled.
     *
     */
    play: () => void;
    /**
     ...
     *
     * @description
     * This function takes a value as input and updates the
     * slider based on the value.
     ...
     * If the value passes the validation and falls within the range of the
     * minimum and maximum time,
     * it updates the display value and adjusts the position of the slider
     * accordingly.
...
type SpriteAnimation = {
     ...
     * If the sprite doesn't exist, it will create a new
     * sprite with `Sprite` attributes.
     */
    saveAnimation: () => void
    /**
     ...
     * @description
     * This function takes a FileList as input and loads the files
     * into the frame collection.
