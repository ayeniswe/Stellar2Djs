...
const Tilemap = () => {
  ...
  /**
   *  This effect handles the initialization of the tileset chosen,
   * set the background image of the tiles, and set the ready property
   * of the editor input to receive input
   */
  useEffect(() => {
