...
import { KMMapping, SceneEditorInput } from '../libs/input';

/**
 * The `SceneEditor` class is responsible for managing the `SceneEditorUI` behavior and provides a way to set and interact with the canvas brush.
 * 
 * @class
 */
class SceneEditor {
    private __input: SceneEditorInput;
    static brush: Brush;
 
    constructor(ctx: CanvasRenderingContext2D, mapping: KMMapping, id?: string) {
        this.__input = new SceneEditorInput(ctx, mapping, id);
    }
